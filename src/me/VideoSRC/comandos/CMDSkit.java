...
/*    */     {
	if (!p.hasPermission("kombo.cmd.report")){
  	  sender.sendMessage("§c§lERRO §fVoce nao tem permissao para executar esse comando");
  	  return true;
    }
/* 42 */       if (args.length == 0) {
/* 43 */         p.sendMessage("§6§lKombo§f§lPvP" + "" + "§7> §cUse /skit criar|aplicar [nome]|[raio]");
/* 44 */         return true;
/*    */       }
/* 46 */       if (args[0].equalsIgnoreCase("criar")) {
/* 47 */         if (args.length == 1) {
/* 48 */           p.sendMessage("§6§lHG" + "" + "§7> §cUtilize: /skit criar [Nome do Kit]");
/* 49 */           return true;
/*    */         }
...
/* 54 */         p.sendMessage("§6§lHG" + "" + "§7> §aKit " + args[1] + " §a criado com sucesso!");
/* 55 */         return true;
/*    */       }
/* 57 */       if (args[0].equalsIgnoreCase("aplicar")) {
/* 58 */         if (args.length <= 2) {
/* 59 */           p.sendMessage("§6§lHG" + "" + "§7> §cUso correto: /skit aplicar [kit] [raio]");
/* 60 */           return true;
/*    */         }
/* 62 */         String name = args[1];
/* 63 */         if ((!this.kit.containsKey(name)) && (!this.armadura.containsKey(name))) {
/* 64 */           p.sendMessage("§6§lHG" + "" + "§7> §cEsse kit " + name + " nao existe!");
/* 65 */           return true;
/*    */         }
/* 67 */         if (isInt(args[2])) {
...
/*    */             }
/*    */           }
/* 77 */           p.sendMessage("§6§lHG" + "" + "§7> §aKit " + name + " foi aplicado para os jogadores a um raio de " + numero + " blocos");
/* 78 */           return true;
/*    */         }
/*    */       }
/*    */     }
